...
def main():
    ...
    parser.add_argument('--output_dir', default='TrainModel/', type=str)
    parser.add_argument('--data_name', default='Tenrec', type=str)
    ...
    parser.add_argument('--exposure_model_name', default="SASrec", type=str, help="SASrec, GRU4rec, or mix")
    ...
    # save model args
    time_stamp = datetime.datetime.now().strftime('%Y-%m-%d-%H_%M_%S')
    ...
    if args.do_eval:
        args.checkpoint_path = os.path.join(args.output_dir, "SASRec-Tenrec-1-Exposure1-2025-05-08-01_19_26.pt")
